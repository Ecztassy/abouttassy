...
interface ThemeBannerProps {
  theme: Theme
  bannerImages: Record<Theme, string>
}
...
function ThemeBanner({ theme, bannerImages }: ThemeBannerProps) {
  const bannerSrc = bannerImages[theme] || "/placeholder.svg?height=200&width=600"

  return (
    <div className="relative w-full h-full overflow-hidden rounded-lg">
      <Image src={bannerSrc || "/placeholder.svg"} alt={`${theme} theme banner`} fill className="object-cover" />
    </div>
  )
}
...
export default function AboutMe() {
  ...
  useEffect(() => {
    async function fetchAniListData() {
      try {
        const animeEntry = await fetchData("Ecztassy", "ANIME")
        const mangaEntry = await fetchData("Ecztassy", "MANGA")
  ...
  async function fetchData(userName: string, type: "ANIME" | "MANGA"): Promise<AnimeEntry | null> {
    const query = `
  ...
  function getMostRecentEntry(animeEntry: AnimeEntry | null, mangaEntry: AnimeEntry | null): AnimeEntry | null {
    ...
    try {
      ...
      if (track) {
        setLastTrack({
          ...
          albumArt: track.image[2]["#text"] || "/placeholder.svg?height=64&width=64",
          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              <div className="absolute top-0 right-4 z-10 p-1">
                <Tabs defaultValue="persona" onValueChange={(value) => setCurrentTheme(value as Theme)}>
                  <TabsList className="grid grid-cols-5 w-fit bg-black">
                    <TabsTrigger value="persona" className="text-xs px-2 text-white">
                      Persona
                    </TabsTrigger>
                    <TabsTrigger value="ultrakill" className="text-xs px-2 text-white">
                      Ultrakill
                    </TabsTrigger>
                    <TabsTrigger value="madoka" className="text-xs px-2 text-white">
                      Madoka
                    </TabsTrigger>
                    <TabsTrigger value="lain" className="text-xs px-2 text-white">
                      Lain
                    </TabsTrigger>
                    <TabsTrigger value="sailor" className="text-xs px-2 text-white">
                      Sailor
                    </TabsTrigger>
                  </TabsList>
                </Tabs>
              ...
              <div className="flex flex-col md:flex-row items-center gap-6 mb-8">
                <AnimatePresence mode="wait">
                  ...
                  >
                    <Image
                      src={profileImages[currentTheme] || "/placeholder.svg?height=128&width=128"}
                      alt="Profile"
                      width={128}
                      height={128}
                      className="object-cover w-full h-full"
                    />
                    {glitchEffect && <div className="absolute inset-0 bg-green-500/30 mix-blend-overlay"></div>}
                  </motion.div>
                </AnimatePresence>
                ...
                <div className="text-center md:text-left top-5 relative">
                  <motion.h1
                    ...
                    animate={{
                      ...
                      filter: glitchEffect ? ["blur(0px)", "blur(1px)", "blur(0px)"] : "blur(0px)",
                    }}
                  >
                    XTassy
                  </motion.h1>
                  <div className="mt-2 flex flex-wrap justify-center md:justify-start gap-2">
                    <span className={`px-3 py-1 rounded-full text-sm ${themeAccentClasses[currentTheme]} text-white`}>
                      INTP / 5w4
                    </span>
                    <span className={`px-3 py-1 rounded-full text-sm ${themeAccentClasses[currentTheme]} text-white`}>
                      He/Him
                  ...
                  <div className="mt-4 flex justify-center md:justify-start gap-4">
                    ...
                    >
                      <Link href="https://github.com/Ecztassy" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                    ...
                    <motion.div
                      ...
                      className="opacity-70 hover:opacity-100 transition-opacity"
                    >
                      <Link href="https://www.instagram.com/ecztassy/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                    ...
                    <motion.div
                      ...
                      className="opacity-70 hover:opacity-100 transition-opacity"
                    >
                      <Link href="https://steamcommunity.com/id/CrazynessIsTheKey/" target="_blank" rel="noopener noreferrer" aria-label="Steam">
                        <svg
                    ...
                    <motion.div
                      ...
                      onClick={() => {
                        if (navigator.clipboard && navigator.clipboard.writeText) {
                          navigator.clipboard.writeText("ecztassy") // Replace with your actual Discord username
                            .then(() => alert("Discord username copied to clipboard!"))
                            .catch(() => alert("Failed to copy Discord username."));
                        } else {
                    ...
                    <motion.div
                      ...
                      className="opacity-70 hover:opacity-100 transition-opacity"
                    >
                      <Link href="https://open.spotify.com/user/31ofiy4tfdrv7ek4gv3gyu7pjonm" target="_blank" rel="noopener noreferrer" aria-label="Spotify">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 24 24"
                          fill="none"
                    ...
                    <motion.div
                      ...
                      className="opacity-70 hover:opacity-100 transition-opacity"
                    >
                      <Link href="https://spacehey.com/ecztassy_" target="_blank" rel="noopener noreferrer"   aria-label="MySpace">
                        <svg
                          fill="#ffffff"
                          height="20px"
                          width="20px"
                    ...
                    <motion.div
                      ...
                      className="opacity-70 hover:opacity-100 transition-opacity"
                    >
                      <Link href="https://portfoliodiogof.vercel.app/" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
              ...
              <div className="mb-8 h-64 rounded-lg overflow-hidden border border-white/20">
                <AnimatePresence mode="wait">
                  ...
                  >
                    <ThemeBanner theme={currentTheme} bannerImages={bannerImages} />
                  </motion.div>
                </AnimatePresence>
              </div>
                ...
                <div className="space-y-6">
                  ...
                  >
                    <h2 className="text-xl font-bold mb-3 flex items-center gap-2 text-white">
                      <Heart className="w-5 h-5 text-white" /> Interests & Hobbies
                    </h2>
                    <ul className="space-y-2 text-white">
                      ...
                      <li className="flex items-center gap-2">
                        <Gamepad2 className="w-4 h-4 flex-shrink-0 text-white" />
                        <span>ULTRAKILL (blood is fuel), Persona, MTG, YGO</span>
                      </li>
                      <li className="flex items-center gap-2">
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div className="space-y-3 text-white">
                      <p>
                        Autistic Powerhouse. I'm a 17-year-old INTP/5w4 with a passion for
                  ...
                  >
                    <h2 className="text-xl font-bold mb-3 flex items-center gap-2 text-white">
                      <Headphones className="w-5 h-5 text-white" /> Currently Watching
                    </h2>
                    {loading ? (
                      ...
                      <div className="flex items-center gap-4">
                        <div className="w-16 h-16 rounded overflow-hidden flex-shrink-0">
                          <Image
                            src={lastAnime.media.coverImage.medium || "/placeholder.svg?height=64&width=64"}
                        ...
                        <div className="text-white">
                          <h3 className="font-medium">{lastAnime.media.title.romaji}</h3>
                          <p className="text-sm opacity-80">
                            Progress: {lastAnime.progress}/{lastAnime.media.episodes || lastAnime.media.chapters || "?"}
                          </p>
                        </div>
                      </div>
                    ) : (
                      <p className="text-white">No recent anime or manga found.</p>
                    )}
                  </motion.div>
                  ...
                  >
                    <div className="flex justify-between items-center mb-3">
                      ...
                      >
                        <RefreshCw className={`w-4 h-4 ${lastfmLoading ? "animate-spin" : ""} text-white`} />
                    ...
                    {lastfmLoading ? (
                      ...
                      <div className="text-red-400 text-sm">
                        <p>{lastfmError}</p>
                        <Button variant="outline" size="sm" onClick={fetchLastFmData} className="mt-2 text-white">
                          Try Again
                        </Button>
                      </div>
                    ) : lastTrack ? (
                      <div className="flex items-center gap-4">
                        <div className="w-16 h-16 rounded overflow-hidden flex-shrink-0">
                          <Image
                            src={lastTrack.albumArt || "/placeholder.svg?height=64&width=64"}
                            alt={lastTrack.album}
                            width={64}
                            height={64}
                            className="object-cover"
                        ...
                        <div className="text-white">
                          ...
                          <p className="text-sm opacity-80">{lastTrack.artist}</p>
                          <p className="text-xs opacity-60">{lastTrack.album}</p>
              ...
              <div className="mt-8 pt-4 border-t border-white/20 flex flex-col sm:flex-row justify-between items-center gap-4">
                <div className="text-sm opacity-70 text-white">
                  {currentTheme === "lain" ? (
                    ...
                    >
                      <span className="font-mono">And you don't seem to understand...</span>
                    </motion.div>
                ...
                <div className="text-sm opacity-70 text-white">Created by 4chan and YouTube chaos</div>
              </div>
              ...
              {currentTheme === "ultrakill" && (
                <div className="absolute bottom-0 right-0 w-32 h-32 opacity-10">
                  <svg viewBox="0 0 100 100" className="w-full h-full">
                    <path d="M10,10 L90,90 M10,90 L90,10" stroke="red" strokeWidth="4" />
                    <circle cx="50" cy="50" r="30" fill="none" stroke="orange" strokeWidth="3" />
                  </svg>
                </div>
              )}
                ...
                <div className="absolute bottom-0 left-0 w-40 h-40 opacity-10">
                  <svg viewBox="0 0 100 100" className="w-full h-full">
                    <path
                      ...
                      strokeWidth="2"
                    />
                    <path d="M30,30 L70,70 M30,70 L70,30" stroke="purple" strokeWidth="2" />
                  </svg>
                </div>
              )}
              ...
              {currentTheme === "lain" && (
                <>
                  <div className="absolute inset-0 pointer-events-none">
                    {glitchEffect && <div className="absolute inset-0 bg-green-500/5"></div>}
